...
class PetInfoRegisterFragment : Fragment() {

    lateinit var commonNavActivity: CommonNavActivity

    companion object {
        fun newInstance(): PetInfoRegisterFragment = PetInfoRegisterFragment()
    }
    ...
    override fun onCreateView(
        ...
        var view: View =
            inflater.inflate(R.layout.activity_pet_info_register, container, false) //반환형 : View }
